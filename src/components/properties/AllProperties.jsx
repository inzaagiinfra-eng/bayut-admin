...
const AllProperties = () => {
  ...
  const getallproperties = async () => {
    ...
    const response = await axios.get(
      "http://localhost:8000/api/properties?status=pending",
          ...
          <tbody>
            {allproperties.map((item, index) => (
              <tr key={item._id}>
                ...
                <td className="border border-gray-300 px-4 py-2">
                  <Link
                    className="bg-blue-500 hover:bg-blue-400 px-2 flex gap-1 justify-center items-center py-1 cursor-pointer rounded-2xl text-white text-sm"
                ...
                <td className="border border-gray-300 px-4 py-2">
                  ...
                  >
                    <span>View</span> <CiEdit  className="w-4 h-4" />
                  </Link>
                </td>
                <td className="border border-gray-300 px-4 py-2">
                  <button
                    ...
                    onClick={() => deletePropertie(item._id)}
                  >
