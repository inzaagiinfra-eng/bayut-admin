        ...
        >
          <nav>
            <ul className="space-y-2">
              ...
              <button onClick={logout} className="flex cursor-pointer items-center  p-2 gap-4 bg-red-600 text-white rounded-2xl "><RiLogoutCircleLine className="w-5 h-5" /> Lougout</button>
            </ul>
          </nav>
        </aside>
