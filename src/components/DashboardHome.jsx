    ...
    <div>
      <div className="flex flex-col justify-center items-center ">
        ...
        <p className="pt-6 text-xl text-gray-500 font-semibold">
          Manage your Real Estate data from here!
        </p>
      </div>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 mt-12 px-6">
        ...
        >
          <div className="flex flex-col items-center text-center px-2">
            <GiHomeGarage className="w-11 mt-3 h-11 text-primary" />
            <h1 className="mt-2 pb-2 font-bold text-lg text-gray-900 flex gap-2">
              <span>All</span> <span>Properties</span>
            </h1>
            <p className="text-[12px] text-gray-600 leading-tight max-w-40">
               manage your all property
            </p>
            <h1 className="text-lg font-bold mt-2">{order} Properties</h1>
          </div>
        </Link>
        <Link
          to="/manage-banner"
        ...
        >
          <div className="flex flex-col items-center text-center px-2">
            <CiImageOn className="w-11 mt-3 h-11 text-primary" />
            <h1 className="mt-2 pb-2 font-bold text-lg text-gray-900 flex gap-2">
              <span>All</span> <span>Broker</span>
            </h1>
            <p className="text-[12px] text-gray-600 leading-tight max-w-40">
              manage you all broker
            </p>
            <h1 className="text-lg font-bold mt-2">{banner} Brokers</h1>
          </div>
        </Link>
        <Link
          to="/all-category"
        ...
        >
          <div className="flex flex-col items-center text-center px-2">
            <MdCategory className="w-12 mt-3 h-12 text-primary" />
            <h1 className="mt-2 pb-2 font-bold text-lg text-gray-900 flex gap-2">
        ...
        >
          <div className="flex flex-col items-center text-center px-2">
            <BsSubstack className="w-10 mt-3 h-10 text-primary" />
        ...
        >
          <div className="flex flex-col items-center text-center px-2">
            <LuMessageCircleMore className="w-11 mt-3 h-11 text-primary" />
            <h1 className="mt-2 pb-2 font-bold text-lg text-gray-900 flex gap-2">
        ...
        >
          <div className="flex flex-col items-center text-center px-2">
            <GiFalloutShelter className="w-11 mt-3 h-11 text-primary" />
            <h1 className="mt-2 pb-2 font-bold text-lg text-gray-900 flex gap-2">
        ...
        >
          <div className="flex flex-col items-center text-center px-2">
            <FaUsers className="w-11 mt-3 h-11 text-primary" />
            <h1 className="mt-2 pb-2 font-bold text-lg text-gray-900 flex gap-2">
        ...
        >
          <div className="flex flex-col items-center text-center px-2">
            <MdDiscount className="w-11 mt-3 h-11 text-primary" />
            <h1 className="mt-2 pb-2 font-bold text-lg text-gray-900 flex gap-2">
